...
class MultiPtcGeometry(BaseImplicitGeometryGenerator):
    ...
    def configure(self) -> None:
        super().configure()
        self.geometry_list = [
            threestudio.find(self.cfg.base_geometry_type)(self.cfg.base_geometry).to(self.device)
    ...
    def forward(
        ...
        return self.geometry_list[self.particle_id].forward(
            points, output_normal
        )
